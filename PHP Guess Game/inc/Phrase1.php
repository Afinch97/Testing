...
class Phrase
{
    ...
    public $selected =[];
    public $phrases = [
        'Hello World'=>"A programmer's first made program",
        'Web Programming'=> "Your favorite class",
        'Georgia State University'=> "Your school",
        'Panthers'=>"Mascot",
        'Computer Science'=>"Most likely your major",
        'Project'=>"What you do last minute",
        'Peaches'=>"What Justin Bieber gets from Georgia",
        'Henry Louis'=>"Professor",
        'South'=> "Known for its hospitality and racism"
    ];
