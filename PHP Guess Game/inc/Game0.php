...
class Game
{
    ...
    public function displayKeyboard()
    {
        ...
        $keyboard .= '<form action="play2.php" method="POST">';
    ...
    public function gameOver()
    {
        if ($this->checkForLose() == true) {
            ...
            <input id="btn__reset" type="submit" name="start" value="Try Level 1" />
            </form>;
            ...
            <input id="btn__reset" type="submit" name="start" value="Try Level 3" />
            </form>;
            <form action="leaderBoard.php" method="POST">
            <input id="btn__reset" type="submit" name="start" value="Leaderboard" />
            </form>';
